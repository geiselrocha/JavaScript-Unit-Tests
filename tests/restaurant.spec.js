...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const parameter = { food: {}, drink: {} };
    expect(createMenu(parameter).fetchMenu()).toMatchObject(parameter);
    ...
    expect(teste5.consumption[0]).toBe('coxinha');
    ...
    expect(teste6.consumption).toEqual(expect.arrayContaining(['coxinha', 'agua', 'sopa', 'sashimi']));
    ...
    teste7.order('agua');
    teste7.order('coxinha');
    expect(teste7.consumption).toEqual(expect.arrayContaining(['coxinha', 'agua', 'coxinha']));
    ...
    // ```
    const teste8 = createMenu({ food: {coxinha: 4.50, sashimi: 12, sopa:17.90}, drink: {agua: 3.50, cafe: 7.50, guarana: 6.50} });
    teste8.order('coxinha');
    teste8.order('sashimi');
    teste8.order('sopa');
    teste8.order('agua');
    teste8.order('cafe');
    teste8.order('guarana');
    expect(teste8.pay()).toBeCloseTo(51.9);
